...
//  state_ |= 0x40;     // vb, we don't want clock output here
//  state_ |= Random::state() & 0x80; // vb, no rand step at each clock pulse
...
//      state_ |= 0x40;    // vb, output step instead of clock signal
      Random::Update();
